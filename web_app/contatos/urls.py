...
urlpatterns = [
	...
	path('membros/<int:pk>/', views.generic_detail_view, {'entity_type': 'membro'}, name='membro_detail'),
	...
	path('membros/<int:pk>/editar/', views.generic_edit_view, {'entity_type': 'membro'}, name='membro_edit'),
	...
	path("reunioes/<int:pk>/relatorio/aviso", views.warning_relatorio_modal_view, name="warning_relatorio"),
